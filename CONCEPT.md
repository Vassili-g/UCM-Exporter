...
| [DTCG](https://www.designtokens.org/tr/2025.10/format/) | Définit un format d’échange pour les tokens et leurs références | UCM emprunte à DTCG la structure de `tokens.json`, ses alias et ses `$extensions`, dans la forme que lit Style Dictionary v4 ; [docs/FORMAT.md](./docs/FORMAT.md#partie-2--export-tokens) donne les écarts avec le module `2025.10`. Le contrat de composant décrit les variantes, états, placements et règles d’usage qui emploient ces tokens |
