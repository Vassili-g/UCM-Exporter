...
2. **Brands** — palettes par marque, alias vers Primitives.
   `Marque1/Primary/50…900` où `primary.50 → Primitives.Terracota.50`,
   `Marque1/Secondary/50…900 → Primitives.Terracota.*`. D'autres marques
   viendront.
...
3. **Brand Tokens** — couleurs de marque réellement utilisées, échelle
   ...
   subtle,subtlest}` où `strong → Brand Tokens.Marque1.Primary.600`. Idem
...
- (a) un jeu de valeurs par mode/marque (ex. fichiers/sections
  `tokens.brand-marque1.json`, …), mêmes noms de tokens, valeurs du mode ;
...
Brands — palettes par marque, alias vers Primitives. Marque1/Primary/50…900 où primary.50 → Primitives.Terracota.50, Marque1/Secondary/50…900 → Primitives.Terracota.*. D'autres marques viendront.
Brand Tokens — couleurs de marque réellement utilisées, échelle réduite par emphase, avec gestion des modes (1 mode = 1 marque) pour switcher la marque dans les designs. Primary/{strong,emphasis,default, subtle,subtlest} où strong → Brand Tokens.Marque1.Primary.600. Idem Secondary. Les modes de cette collection portent la mécanique multi-marque — ils NE sont PAS ignorés (voir Partie 2, étape modes).
...
(a) un jeu de valeurs par mode/marque (ex. fichiers/sections tokens.brand-marque1.json, …), mêmes noms de tokens, valeurs du mode ;
