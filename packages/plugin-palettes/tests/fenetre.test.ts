...
test('la fenêtre s’ouvre à 650 × 720 et ne descend pas sous 500 × 520', () => {
  assert.deepEqual(TAILLE_PAR_DEFAUT, { largeur: 650, hauteur: 720 });
...
test('une taille rangée à l’ancien défaut, 600 × 720, s’ouvre à 650 × 720 ; toute autre taille rangée se garde', () => {
  assert.deepEqual(tailleALOuverture({ largeur: 600, hauteur: 720 }), { largeur: 650, hauteur: 720 });
