...
Ce dossier rejoint `packages/kit/` quand la Phase 1 le crée (T1.2). Il vit
ensuite tant que la fenêtre de lecture inclut la 11.0, et disparaît quand elle
se referme au-dessus — au même moment que le code de compatibilité qu'il
couvre, jamais avant.
