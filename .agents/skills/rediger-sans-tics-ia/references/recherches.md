...
règles, soit 439 tirets sur les documents de référence. Il est à 0,3 après, et
les quatorze restants tiennent en titre ou en cellule de tableau, où le tiret
sépare deux colonnes au lieu de couper une phrase.
...
Chaque règle du dépôt vient d'une erreur réelle, et la première rédaction
faisait suivre presque chaque règle du récit de son erreur. Le récit aide une
fois et coûte à chaque relecture. La règle retenue garde la justification quand
elle change une décision du lecteur, une à deux phrases, et laisse le reste à
Git, message de commit compris.

## Mesure

La passe de réécriture qui a posé ces règles a ramené les documents de référence
de 439 tirets cadratins à 14, tous en titre ou en cellule de tableau, et
d'environ deux cents emphases par capitales à zéro. Le détail, document par
document, est dans le commit qui l'a faite.
