...
```sh
npx --yes @ucm-kit/cli@0.1.48 init --components src/components --tokens src/tokens
```
...
```sh
npx --yes @ucm-kit/cli@0.1.48 check
```
...
```sh
npm install --save-dev @ucm-kit/adapter-typescript@0.1.41
```
...
1. Dans un clone du projet, lancez :
   ...
   ```sh
   npx --yes @ucm-kit/cli@0.1.48 init --forge gitlab
   ```
