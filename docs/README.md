...
| [notes/Recherches/Archi Tokens Multi-marques/RECHERCHE-ARCHI-MULTIMARQUES.md](./notes/Recherches/Archi%20Tokens%20Multi-marques/RECHERCHE-ARCHI-MULTIMARQUES.md) | La forme à donner aux collections de variables pour tenir cinq marques et le mode sombre sans écrire le même fait trois fois, et le script qui relève la duplication d'un `tokens.json` |
