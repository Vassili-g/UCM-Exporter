...
| T321 | [L602](../../../../packages/plugin-palettes/src/ui/textes.ts) · ` confirmationDuDessin ` | `` `Dessiner les ${nombre} palettes ? Chacune pose plus de cinq cents calques sur la planche.` `` | La génération de {nombre} palettes ajoutera plus de 500 calques par palette. Confirmez pour lancer la génération. |
