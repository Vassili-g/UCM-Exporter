...
```sh
npx --yes @ucm-kit/cli@0.1.36 init                       # écrit les cinq fichiers manquants
npx --yes @ucm-kit/cli@0.1.36 check --report ci-report.md
```
...
```sh
npx --yes @ucm-kit/cli@0.1.36 init \
...
```sh
npm install @ucm-kit/core@0.1.32
```
...
[`@ucm-kit/adapter-typescript@0.1.29`](./packages/adapter-typescript/README.md)
