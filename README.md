...
```sh
npx --yes @ucm-kit/cli@0.1.37 init                       # écrit les cinq fichiers manquants
...
```sh
npm install @ucm-kit/core@0.1.33
```
...
[`@ucm-kit/adapter-typescript@0.1.30`](./packages/adapter-typescript/README.md)
