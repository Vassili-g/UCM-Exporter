...
```sh
npx --yes @ucm-kit/cli@0.1.31 init                       # écrit les cinq fichiers manquants
...
```sh
npm install @ucm-kit/core@0.1.30
```
...
[`@ucm-kit/adapter-typescript@0.1.24`](./packages/adapter-typescript/README.md)
