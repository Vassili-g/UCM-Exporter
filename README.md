...
```sh
npx --yes @ucm-kit/cli@0.1.38 init                       # écrit les cinq fichiers manquants
...
```sh
npm install @ucm-kit/core@0.1.34
```
...
[`@ucm-kit/adapter-typescript@0.1.31`](./packages/adapter-typescript/README.md)
